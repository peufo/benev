			...
			{#each steps as step, i}
				...
				>
					...
					<div class={i % 2 === 1 ? 'md:order-1' : ''}>
						<div
							class="rounded-3xl aspect-[4/3] flex items-center justify-center relative overflow-hidden {i % 2 === 0 ? 'bg-primary' : 'bg-brand-beige'}"
						>
							{#if i === 0}
								<!-- Étape 1 : Événement qui se construit -->
								<svg viewBox="0 0 200 160" class="w-48 h-auto relative z-10">
									<rect x="40" y="30" width="120" height="100" rx="12" fill="none" stroke="white" stroke-width="3" opacity="0.3" />
									<rect x="55" y="50" width="90" height="8" rx="4" fill="white" opacity="0.6">
										<animate attributeName="width" from="0" to="90" dur="1.2s" fill="freeze" />
									</rect>
									<rect x="55" y="70" width="70" height="6" rx="3" fill="white" opacity="0.4">
										<animate attributeName="width" from="0" to="70" dur="1s" begin="0.3s" fill="freeze" />
									</rect>
									<rect x="55" y="85" width="80" height="6" rx="3" fill="white" opacity="0.4">
										<animate attributeName="width" from="0" to="80" dur="1s" begin="0.5s" fill="freeze" />
									</rect>
									<circle cx="150" cy="45" r="8" fill="white" opacity="0.8">
										<animate attributeName="r" from="0" to="8" dur="0.5s" begin="0.8s" fill="freeze" />
									</circle>
								</svg>
							{:else if i === 1}
								<!-- Étape 2 : Bénévoles qui s'ajoutent -->
								<svg viewBox="0 0 200 160" class="w-48 h-auto relative z-10">
									<g opacity="0.3">
										<circle cx="60" cy="55" r="12" fill="white" />
										<rect x="45" y="72" width="30" height="20" rx="8" fill="white" />
									</g>
									<g opacity="0.5">
										<circle cx="100" cy="55" r="12" fill="white">
											<animate attributeName="opacity" from="0" to="1" dur="0.6s" begin="0.4s" fill="freeze" />
										</circle>
										<rect x="85" y="72" width="30" height="20" rx="8" fill="white">
											<animate attributeName="opacity" from="0" to="1" dur="0.6s" begin="0.4s" fill="freeze" />
										</rect>
									</g>
									<g opacity="0.8">
										...
										<rect x="125" y="72" width="30" height="20" rx="8" fill="white">
											<animate attributeName="opacity" from="0" to="1" dur="0.6s" begin="0.8s" fill="freeze" />
										</rect>
									</g>
									<path d="M50 110 L150 110" stroke="white" stroke-width="2" stroke-dasharray="8 4" opacity="0.3" />
									<circle cx="100" cy="110" r="6" fill="white">
										<animate attributeName="cy" from="130" to="110" dur="0.8s" begin="1.2s" fill="freeze" />
									</circle>
								</svg>
							{:else}
								<!-- Étape 3 : Validation -->
								<svg viewBox="0 0 200 160" class="w-48 h-auto relative z-10">
									<circle cx="100" cy="80" r="40" fill="none" stroke="white" stroke-width="3" opacity="0.3" />
									<path d="M80 80 L92 92 L120 65" fill="none" stroke="white" stroke-width="4" stroke-linecap="round" stroke-linejoin="round">
										<animate attributeName="stroke-dasharray" from="0 100" to="100 0" dur="0.8s" fill="freeze" />
									</path>
									<circle cx="100" cy="80" r="40" fill="none" stroke="white" stroke-width="3" opacity="0.6">
										<animate attributeName="r" from="30" to="40" dur="0.6s" fill="freeze" />
									</circle>
								</svg>
							{/if}
						</div>
						<p class="text-center text-xs text-base-content/40 mt-3">
							Placeholder visuel — insérer un GIF ici
						</p>
					</div>
				</div>
			{/each}
