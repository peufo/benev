...
import {
	...
	type FormInputsType,
} from '$lib/fuma-legacy/ui/form/formInput.js'

import type FormSection from '$lib/fuma-legacy/ui/form/FormSection.svelte'
...
export type FormSectionProps<S extends Shape> = ComponentProps<typeof FormSection> & {
	/** hide group if true */
	hide?: BoolOrFunction<S>
}
