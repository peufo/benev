<!-- @migration-task Error while migrating Svelte code: This migration would change the name of a slot (activator to activator_1) making the component unusable -->
<script lang="ts" context="module">
	import { createSingleton, type TippyInstance } from '$lib/fuma/utils/tippy.js'
...
<script lang="ts">
	import { tippy, type TippyProps } from '$lib/fuma/utils/tippy.js'
	import { onMount } from 'svelte'
	import { browser } from '$app/environment'
	import { beforeNavigate } from '$app/navigation'
	import '$lib/fuma/ui/menu/dropdown.css'
