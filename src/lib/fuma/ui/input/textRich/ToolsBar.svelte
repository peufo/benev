<script lang="ts">
	...
	import ToolMenuNode from '$lib/fuma/ui/input/textRich/ToolMenuNode.svelte'
	import ToolMark from '$lib/fuma/ui/input/textRich/ToolMark.svelte'
	import ToolMarkColor from '$lib/fuma/ui/input/textRich/ToolMarkColor.svelte'
	import ToolMarkLink from '$lib/fuma/ui/input/textRich/ToolMarkLink.svelte'
	import ToolMenuAlign from '$lib/fuma/ui/input/textRich/ToolMenuAlign.svelte'
