...
<a
	...
	class="btn btn-square btn-sm btn-ghost scale-0 group-hover:scale-95 opacity-80 delay-[0ms] group-hover:delay-[360ms]"
...
<a
	...
	on:click|stopPropagation
	class="btn btn-square btn-sm btn-ghost scale-0 group-hover:scale-95 opacity-80 delay-[30ms] group-hover:delay-[330ms]"
...
<a
	...
	on:click|stopPropagation
	class="btn btn-square btn-sm btn-ghost scale-0 group-hover:scale-95 opacity-80 delay-[60ms] group-hover:delay-[300ms]"
