...
Organisateurs d'événements (associations, festivals, collectifs sportifs, manifestations locales) qui cherchent une solution simple pour gérer leurs bénévoles. Ils sont souvent bénévoles eux-mêmes, pressés par le temps, et méfiants envers les outils complexes ou payants. Ils découvrent Benev via bouche-à-oreille, recherche web, ou réseaux sociaux.
...
3. **Parler humain** : pas de jargon tech ou marketing. Les mots doivent être ceux qu'un organisateur utiliserait avec ses amis.
4. **Montrer, pas dire** : plutôt qu'une liste de features, des témoignages et des preuves sociales.
5. **Bas-friction avant tout** : le CTA doit être immédiat et sans engagement apparent.

## Accessibility & Inclusion

- WCAG 2.1 AA minimum
- Support réduit mouvement (pas d'animations indispensables)
- Contraste suffisant pour la lecture en extérieur (beaucoup d'organisateurs consultent sur mobile entre deux tâches)
