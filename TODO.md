- [x] Le dashboard n'a que 3 section. Pas besoin de sous menu de navigation.
  - [x] Le sous-titre de "Derniers adhérents" devrait afficher le nombre total d'adhérents
  - [x] Le titre de de la section "Inscriptions" devrait être "Inscription en attentes", on devrait pouvoir choisire d'afficher les inscriptions en attentes chez-nous, ou chez le membre
