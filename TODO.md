...
- [x] Normaliser le style des drawers

- [x] Dans le plan, il faut afficher le ghost de la création de période au survole de la souris

- [ ] Est-ce possible de faire en sorte que benev/src/lib/plan/positionIndicator.ts:15 soit appeler dans le même tick que la modification du zoom ?
